    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(5)) {
          ...
          Stella.defineClassFromStringifiedSource("NATIVE-OUTPUT-STREAM", "(DEFCLASS NATIVE-OUTPUT-STREAM (NATIVE-STREAM) :ABSTRACT? TRUE :CPP-NATIVE-TYPE \"std::ostream*\" :JAVA-NATIVE-TYPE \"org.powerloom.PrintableStringWriter\" :CL-NATIVE-TYPE \"STREAM\")");
          Stella.defineClassFromStringifiedSource("NATIVE-INPUT-STREAM", "(DEFCLASS NATIVE-INPUT-STREAM (NATIVE-STREAM) :ABSTRACT? TRUE :CPP-NATIVE-TYPE \"std::istream*\" :JAVA-NATIVE-TYPE \"org.powerloom.PushbackBufferedReader\" :CL-NATIVE-TYPE \"STREAM\")");
