    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("PRINT-CHARACTER", "(DEFUN PRINT-CHARACTER ((CHAR CHARACTER) (STREAM NATIVE-OUTPUT-STREAM)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "printCharacter", new java.lang.Class [] {java.lang.Character.TYPE, Native.find_java_class("org.powerloom.PrintableStringWriter")}), null);
          ...
          Stella.defineFunctionObject("PRINT-STRING-READABLY", "(DEFUN PRINT-STRING-READABLY ((STRING STRING) (STREAM NATIVE-OUTPUT-STREAM)))", Native.find_java_method("edu.isi.stella.Stella", "printStringReadably", new java.lang.Class [] {Native.find_java_class("java.lang.String"), Native.find_java_class("org.powerloom.PrintableStringWriter")}), null);
