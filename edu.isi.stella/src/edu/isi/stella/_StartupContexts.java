    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("PRINT-CONTEXT", "(DEFUN PRINT-CONTEXT ((SELF CONTEXT) (STREAM NATIVE-OUTPUT-STREAM)))", Native.find_java_method("edu.isi.stella.Context", "printContext", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Context"), Native.find_java_class("org.powerloom.PrintableStringWriter")}), null);
