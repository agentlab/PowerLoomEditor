  ...
  static void helpStartupNeuralNetwork3() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD PRINT-ARRAY ((SELF 2_D_ARRAY) (STREAM NATIVE-OUTPUT-STREAM)) :DOCUMENTATION \"Print the array `self' to `stream'.\")", Native.find_java_method("edu.isi.powerloom.logic.two_D_array", "printArray", new java.lang.Class [] {Native.find_java_class("org.powerloom.PrintableStringWriter")}), ((java.lang.reflect.Method)(null)));
    }
  }
