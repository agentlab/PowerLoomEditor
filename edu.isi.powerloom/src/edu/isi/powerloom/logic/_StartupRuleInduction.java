  ...
  static void helpStartupRuleInduction2() {
    {
      ...
      Stella.defineFunctionObject("PRINT-DECISION-TREE", "(DEFUN PRINT-DECISION-TREE ((TREE DECISION-TREE) (STREAM NATIVE-OUTPUT-STREAM)))", Native.find_java_method("edu.isi.powerloom.logic.DecisionTree", "printDecisionTree", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.DecisionTree"), Native.find_java_class("org.powerloom.PrintableStringWriter")}), null);
      Stella.defineFunctionObject("HELP-PRINT-DECISION-TREE", "(DEFUN HELP-PRINT-DECISION-TREE ((TREE DECISION-TREE) (LEVEL INTEGER) (STREAM NATIVE-OUTPUT-STREAM)))", Native.find_java_method("edu.isi.powerloom.logic.DecisionTree", "helpPrintDecisionTree", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.DecisionTree"), java.lang.Integer.TYPE, Native.find_java_class("org.powerloom.PrintableStringWriter")}), null);
